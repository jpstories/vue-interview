        ...
        <div class="payment__info" v-if="!isLoading">
            ...
            <div class="payment__table">
                <div class="payment__year payment__year-head">
                    ...
                    <div
                        class="payment__year-month payment__year-actions"
                    ></div>
                </div>
            ...
            >
                <b-form
                    class="w-100"
                    @submit="onSubmitUpdatePay"
                    @reset="onResetUpdatePay"
                >
                    <div class="payment__table">
                        <div class="payment__year payment__year-head">
                            <div class="payment__year-month current__month">
                                Январь
                            </div>
        ...
        <div class="payment__checkout" v-if="!isLoading">
            ...
            >
                ...
                <p>
                    ...
                    <b
                        >{{ sumAfterTax }} ₽ (после вычета налога
                        {{ this.ndfl }} %)</b
                    >
                </p>
