    ...
    <div class="v-table">
        ...
        <div class="v-table-filter">
            <label for="input-live"
                >Показать сотрудников с зарплатой менее:</label
            >
            <b-form-input
                id="sortbyprice"
                type="number"
            ...
            <tbody>
                <tr v-for="(user, index) in filteredProducts" :key="index">
                    ...
                    <td>
                        <span
                            >{{
                                user.pay[currencyMonth] | formattedPrice
                            }}
                            ₽</span
                        >
                        <router-link
        ...
        <ModalBlock
            ...
            v-if="showAddModal"
        >
            <b-form @submit.prevent="addHandlerUser" class="w-100">
                <AlertBlock
...
export default {
    ...
    methods: {
        ...
        sortByMaxPrice() {
            ...
            this.sortedUsersByPrice = this.sortedUsersByPrice.filter(function(
                item
            ) {
